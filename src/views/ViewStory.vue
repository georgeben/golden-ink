  ...
  <div class="bg-gray-200 py-24 px-3">
    <div class="bg-white shadow-xl rounded-lg p-3 md:w-3/4 md:mx-auto">
      ...
      <div class="story-image sha">
        <img src="../assets/images/writing.jpeg" alt="Story photo" class="sm:mx-auto" />
      </div>
      <vue-editor
    ...
    <div class="comment-section bg-white shadow-xl rounded-lg mt-6 p-3 md:w-3/4 md:mx-auto">
