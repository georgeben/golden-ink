    ...
    <div class="user-activity md:w-3/4 mx-auto">
      ...
      <div v-if="userStories.length <= 0" class="text-center">
        ...
        <h3 class=" font-medium text-xl">
          It seems like you don't have any stories yet.
        </h3>
        <router-link to="/write">
          <button
            class="cta bg-accent hover:bg-blue-600 w-40 text-white p-3 shadow-xl rounded-md mt-4"
          >
            Write a story
          </button>
        </router-link>
