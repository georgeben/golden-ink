        ...
        >
          ...
          >
            <div class="relative">
              ...
              <span v-if="unreadNotificationCount > 0" class="p-1 bg-accent rounded-full text-white text-xxs absolute right-0 top-0"
                >{{unreadNotificationCount > 20 ? '20+': unreadNotificationCount}}</span
              >
            </div>
          </router-link>
          <ProfileDropdown
...
const notificationNamespace = namespace('notifications');
